...
# Lisp is a type of functional languages
...
crotchet::draw_svg("imgs/multiple-languages.svg")
```
...
```{r changed-reasoning-by-language, cache=FALSE}
by_language_plot("cr1")
```

# Changed reasoning

```{r changed-reasoning-by-paradigm, cache=FALSE}
